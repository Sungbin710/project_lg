...
void on_discovered_cb (GstDiscoverer *discoverer, GstDiscovererInfo *info, GError *err, Discover_Data *data) {
 ...
 void on_finished_cb (GstDiscoverer *discoverer, Discover_Data *data) {
